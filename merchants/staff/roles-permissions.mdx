...
**Staff** has a more limited set of defaults. Staff can view members, issue stamps and points, adjust a points balance, process redemptions, view QR codes, and view analytics. They cannot create or edit loyalty cards, generate QR codes, manage campaigns, or access staff management.
