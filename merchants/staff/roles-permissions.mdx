...
<Frame caption="The Edit Permissions dialog with the Role &amp; Permissions tab selected, showing all six permission categories.">
  <img src="/images/staff/permissions-dialog.svg" alt="Edit Permissions dialog showing role selector, custom permissions toggle, and six permission categories with individual checkboxes" />
</Frame>
