...
- A Details panel with the serial number, the purchase date, and the date of the last tap

The running tap count and the last tap date are the whole per-tag history the dashboard keeps, so compare tags by their counts rather than looking for a log of individual taps.
