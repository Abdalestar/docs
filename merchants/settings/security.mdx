...
<Frame caption="The Security page stacks three sections: Change Password, Two-Factor Authentication, and Active Sessions.">
  <img src="/images/settings/security-overview.png" alt="The Security page showing the Change Password, Two-Factor Authentication, and Active Sessions cards" />
</Frame>

## Change your password

<Frame caption="The Change Password form. Your current password is checked before a new one is saved.">
  <img src="/images/settings/security-change-password.png" alt="The Change Password form with Current Password, New Password, and Confirm New Password fields and the Update Password button" />
</Frame>
...
<Frame caption="The Two-Factor Authentication section. The badge reads Not Enabled until you finish setup; click Enable to start.">
  <img src="/images/settings/security-2fa.png" alt="The Two-Factor Authentication card showing the Authenticator App row, a Not Enabled badge, and the Enable button" />
</Frame>
...
<Frame caption="The Active Sessions section. Sign Out All Sessions ends every session on all devices at once.">
  <img src="/images/settings/security-sessions.png" alt="The Active Sessions card showing the current session and the Sign Out All Sessions button" />
</Frame>
