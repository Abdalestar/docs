...
<Frame caption="The Billing overview tab shows your active plan, usage bars for each limit, and quick access to manage or cancel your subscription.">
  <img src="/images/settings/billing-overview-final.png" alt="Billing overview showing current plan, usage bars, and subscription controls" />
</Frame>
...
<Frame caption="The Plans tab shows all four plans side by side with a Monthly / Annual toggle. Your current plan is highlighted.">
  <img src="/images/settings/billing-plans-tab-final.png" alt="Plan selection showing Starter, Growth, Elite, and Franchise plan cards" />
</Frame>
...
<Frame caption="The Add-ons tab lists every purchasable extra. Availability badges (Growth+, Elite+, All tiers) show which plan each item requires.">
  <img src="/images/settings/billing-addons-tab-final.png" alt="Add-ons store showing Extra Location, Extra Loyalty Card, NFC Tag, QR Batch, AI Insight Pack, and Custom QR Branding" />
</Frame>
