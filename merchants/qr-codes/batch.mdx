...
<Frame caption="The Batch Settings form. Name the batch, set the quantity, and pick one Type and one Action for the whole group.">
  <img src="/images/merchants/qr-codes/batch-qr-form.png" alt="Batch Generate QR Codes form with the Batch Name, Quantity, and Generate button highlighted" />
</Frame>

<Frame caption="The Action menu sets what every code in the batch does when scanned.">
  <img src="/images/merchants/qr-codes/batch-qr-action.png" alt="Action dropdown showing Issue Stamp, Award Points, Check-in, and Redeem Reward" />
</Frame>

<Frame caption="Choosing Award Points reveals a Points Value Per Scan field.">
  <img src="/images/merchants/qr-codes/batch-qr-points.png" alt="Batch form with Award Points selected and the Points Value Per Scan field shown" />
</Frame>
