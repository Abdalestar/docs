...
<Frame caption="The Cards page. Start a new card with the button in the top right corner.">
  <img src="/images/merchants/first-loyalty-program/01-create-card.png" alt="Stamp Cards page with the Create Card button highlighted" />
</Frame>
...
<Frame caption="Card Design: name the card and set how many stamps fill it. A live preview updates on the right.">
  <img src="/images/merchants/first-loyalty-program/02-card-design.png" alt="Card Design step with the card name and stamp goal fields highlighted" />
</Frame>
...
<Frame caption="The Add a reward dialog. Choose the reward type (Main, Sign Up, or Interim) and name what the customer earns.">
  <img src="/images/merchants/first-loyalty-program/03-add-reward.png" alt="Add a reward dialog with the reward name field highlighted" />
</Frame>
...
<Frame caption="Locations: tick the branches where this card can be stamped, or leave All Locations selected.">
  <img src="/images/merchants/first-loyalty-program/04-locations.png" alt="Locations step showing the location checklist" />
</Frame>
...
<Frame caption="Review: check the summary, then publish the card or save it as a draft.">
  <img src="/images/merchants/first-loyalty-program/05-review.png" alt="Review step with the Publish Card and Save as Draft buttons highlighted" />
</Frame>
