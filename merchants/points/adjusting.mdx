...
To take it off someone, open **Staff**, click **Edit Permissions** on their row, turn on **Use custom permissions**, and clear **Adjust points** under **Loyalty**. The tab stops appearing for them, and Qtap refuses the change if a request reaches it any other way.
