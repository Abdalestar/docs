...
<Frame caption="The sort menu, with options for newest first, recent activity, most stamps, and most points.">
  <img src="/images/merchants/members/02-sort-options.png" alt="Sort menu open showing Newest First, Recent Activity, Most Stamps, and Most Points" />
</Frame>
...
<Frame caption="The per-member menu. Open a profile, send a notification, add a tag, or delete the member.">
  <img src="/images/merchants/members/03-row-menu.png" alt="Three-dot row menu showing View Profile, Add Tag, and Delete Member" />
</Frame>
