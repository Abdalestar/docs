...
<Frame caption="The Campaigns page. Click New Campaign to open the wizard.">
  <img src="/images/campaigns/birthday-campaigns-list-final.svg" alt="Campaigns list showing active campaigns and the New Campaign button" />
</Frame>
...
<Frame caption="Step 1: choose Birthday Rewards and give the campaign a name.">
  <img src="/images/campaigns/birthday-wizard-type-final.svg" alt="Campaign wizard type selection step with Birthday Rewards highlighted" />
</Frame>
...
<Frame caption="Step 2: pick how many days before the birthday to send the notification.">
  <img src="/images/campaigns/birthday-wizard-trigger-final.svg" alt="Campaign wizard trigger step showing birthday send timing options" />
</Frame>
