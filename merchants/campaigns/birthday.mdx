...
<Frame caption="Step 1, Type: choose Birthday Rewards and give the campaign a name.">
  <img src="/images/campaigns/birthday-01-type.png" alt="The campaign wizard Type step with Birthday Rewards selected and the Campaign Name field filled" />
</Frame>
...
<Frame caption="Step 2, Trigger: choose how many days before the birthday the notification sends. The default is 3 days before.">
  <img src="/images/campaigns/birthday-02-trigger.png" alt="The Trigger step showing the send-timing dropdown set to 3 days before birthday" />
</Frame>

<Frame caption="Step 4, Message: write the Notification Title and Message. A live preview shows how it looks on a phone.">
  <img src="/images/campaigns/birthday-03-message.png" alt="The Message step with the Notification Title and Message fields filled and a phone preview below" />
</Frame>

<Frame caption="Step 7, Review: check the summary, then Activate Campaign to start it or Save as Draft to publish later.">
  <img src="/images/campaigns/birthday-04-review.png" alt="The Review step summarizing the birthday campaign with Activate Campaign and Save as Draft buttons" />
</Frame>
