...
<Frame caption="The Campaigns page. Click New Campaign to open the wizard.">
  <img src="/images/campaigns/campaigns-list-final.jpg" alt="Campaigns list showing campaign cards and a New Campaign button" />
</Frame>
...
<Frame caption="Type step: Birthday Rewards selected with a campaign name filled in.">
  <img src="/images/campaigns/campaign-wizard-type-selected-final.jpg" alt="Campaign wizard type step with Birthday Rewards card selected and campaign name field filled" />
</Frame>
...
<Frame caption="Trigger step: choose how many days before the birthday to send the notification.">
  <img src="/images/campaigns/campaign-wizard-trigger-final.jpg" alt="Campaign wizard trigger step showing timing options: on the day, 1 day before, 3 days before, 7 days before" />
</Frame>
