...
At the top of the page are five cards. They cover the whole life of the campaign so far, not a date range.

<Frame caption="A campaign's stats page: sends, opens, clicks, redemptions, and estimated revenue. This campaign is a claimable offer, so it has never pushed and Total Sent sits at zero.">
  <img src="/images/campaigns/campaign-stats-cards.png" alt="Campaign stats page showing Total Sent, Opened, Clicked, Redeemed, and Est. Revenue cards" />
</Frame>

- **Total Sent** is how many members received the notification.
- **Opened** is how many of them opened it.
- **Clicked** is how many tapped the notification itself.
...
The small line under Opened, Clicked, and Redeemed reads **% of sends**, and each one divides by Total Sent. A campaign customers claim for themselves never pushes, so those percentages stay at 0% even once people have opened and redeemed it. See [What the campaign numbers mean](/merchants/campaigns/analytics) for how each figure is counted.
